...
import useMonthSummaries from "../../../../../shared/hooks/useMonthSummaries";
...
export default function usePanelState({
  ...
  // --- INITIAL auto-scroll ---
  // Wait for grid sizing before snapping to the current/first month.
  ...
  useEffect(() => {
    ...
    // double rAF to ensure react-window measures
    let raf1, raf2;
